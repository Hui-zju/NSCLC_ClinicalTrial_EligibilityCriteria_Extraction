...
common = {
    "exp_name": "trial_split_variation_part_labeled",
...
train_config = {
    "train_data": "train_data.json",  # train_data.json
...
bert_config = {
    "data_home": "dataset/data4bert",
    "bert_path": "bert-base-uncased",  # ../../pretrained_models/
    "hyper_parameters": {
        "lr": 5e-5,  # 5e-5
    },
}
